...
//to the screen in a gradient in the x and y dimensions. 
//the color should be smoothly blended in all directions 
//to look like the target image, but the current mapping 
//result seems to be off (its mostly yellow). fix it to be an 
//even gradient across the width and height of the canvas.
